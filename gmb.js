/* =============================================
    ...
    const profiles = [
      { id: 'GMB-2026-0001', gender: 'Groom', age: 43, religion: 'Hindu', caste: 'Soni', subCaste: 'Adeshara', height: "5'11\"", education: '10th', occupation: 'Job', income: '~₹55,000 Monthly', city: 'Ahmedabad', state: 'Gujarat', country: 'India', marital: 'Never Married', languages: 'Gujarati, Hindi', horoscope: 'None', lifestyle: 'Vegetarian, Non-Smoker', hobbies: 'Cricket, Reading, Travel', family: 'Upper Middle Class, Job Background', description: 'Ambitious and grounded young man from a well-respected Soni business family in Ahmedabad. Values family traditions while embracing modern values. Seeks a life partner who is educated, independent, and family-oriented.', expectations: 'Educated bride, from Gujarat. Values tradition and family.' },
      { id: 'GMB-2026-0002', gender: 'Bride', age: 39, religion: 'Hindu', caste: 'Aggarwal', subCaste: 'Singla', height: "5'1\"", education: 'MBA', occupation: 'Job', income: '~₹3 LPA', city: 'Kalyan', state: 'Maharashtra', country: 'India', marital: 'Never Married', languages: 'Hindi, English', horoscope: 'N.A.', lifestyle: 'Vegetarian, Non-Smoker', hobbies: 'Yoga, Cooking, Art', family: 'Nuclear Family', description: 'Simple, cultured, and well-educated girl. Deeply rooted in values and traditions. Passionate about working and family. Looking for a kind-hearted life partner.', expectations: 'Graduate groom, educated, employed/business, family-oriented.' },
      ...
      { id: 'GMB-2026-0004', gender: 'Bride', age: 63, religion: 'Hindu', caste: 'Shah', subCaste: 'Vanik', height: "5'5\"", education: 'SSC Passed', occupation: 'Catering', income: '10,000 Monthly', city: 'Mumbai', state: 'Maharashtra', country: 'India', marital: 'Widow', languages: 'Gujarati, Hindi', horoscope: 'N.A.', lifestyle: 'Vegetarian', hobbies: 'Cooking, Travel', family: 'There are nobody.', description: 'Looking for a suitable match, lives independently without immediate family dependents.', expectations: 'Well being and respectful person' },
